...
{   
    while(run == 1)
    {
        ...
        //TODO change the absolute path for stucture
        //string used to store the path of presently operating directory [used when creating a structure]
        char path[PATH_MAX] = "/home/sai/Desktop/coding/clg_sem5_projects/struct/code_for_struct/structures/\0";

        clear_terminal();
        //TODO add feature to upload a structure
